  ...
  return (
    <footer style={{ background: "#ffffff", borderTop: "1px solid #E5EAF5" }} className="py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
        ...
        {/* Diensten column */}
        <div>
          <h4 className="text-sm font-bold uppercase tracking-widest mb-4" style={{ color: "#1F217D" }}>
        ...
        {/* Social column */}
        <div className="flex flex-col gap-4">
          <h4 className="text-sm font-bold uppercase tracking-widest" style={{ color: "#1F217D" }}>
          ...
          <div className="flex items-center gap-[0.1rem]">
            <a
              ...
              aria-label="LinkedIn profiel Marijn Schilder"
              className="min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full transition-colors hover:opacity-70"
              style={{ color: "#444444" }}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp contact opnemen"
              className="min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full transition-colors hover:opacity-70"
              style={{ color: "#444444" }}
            >
