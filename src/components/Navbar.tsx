          ...
          <div className="hidden md:flex items-center gap-[0.6rem]">
            ...
            <div className="flex items-center gap-[0.1rem]">
              <a
                ...
                className={`p-2 rounded-full transition-colors ${solid ? "text-foreground hover:text-accent-blue" : "text-primary-foreground hover:text-accent-blue"}`}
              >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 gradient-brand flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex gap-3 mt-4">
            <button
              onClick={() => setLang("nl")}
              className={`px-4 py-2 rounded-full text-sm font-semibold ${lang === "nl" ? "bg-primary-foreground text-primary" : "text-primary-foreground border border-primary-foreground/30"}`}
            >
              🇳🇱 NL
            </button>
            <button
              onClick={() => setLang("en")}
              className={`px-4 py-2 rounded-full text-sm font-semibold ${lang === "en" ? "bg-primary-foreground text-primary" : "text-primary-foreground border border-primary-foreground/30"}`}
            >
              🇬🇧 EN
            </button>
          </div>
